...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://ahmedalihafeez25_db_user:%40Sublime12345@cluster0.oe0inne.mongodb.net/crm_lead?retryWrites=true&w=majority';
...
async function connectDB() {
  ...
  try {
    ...
    isConnected = true;
    console.log('✅ Connected to MongoDB Atlas (crm_lead database)');
  } catch (error) {
