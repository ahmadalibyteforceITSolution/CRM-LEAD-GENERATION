...
<template>
  ...
  <div
    v-else
    class="group relative inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-xs font-medium bg-rose-50 text-rose-700 border border-rose-200/80 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-800/60 cursor-help"
  >
    <ShieldAlert class="w-3.5 h-3.5 text-rose-600 dark:text-rose-400 animate-pulse" />
    ...
    <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 hidden group-hover:block z-30 w-48 p-2 rounded-lg bg-slate-900 text-white text-[11px] shadow-xl border border-slate-700 pointer-events-none">
      <div class="font-semibold text-rose-400 mb-1">Missing Requirements:</div>
