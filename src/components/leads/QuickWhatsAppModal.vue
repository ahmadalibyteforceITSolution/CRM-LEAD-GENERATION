...
<template>
  ...
  >
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[92vh] flex flex-col overflow-hidden">
      ...
      <!-- Content -->
      <form @submit.prevent="handleSubmitWhatsApp" class="flex-1 overflow-y-auto p-6 space-y-5 text-xs">
        <!-- Quick WhatsApp Launcher & Template Selector -->
        <div class="p-4 rounded-xl bg-emerald-50/50 dark:bg-emerald-950/30 border border-emerald-200/80 dark:border-emerald-800/80 space-y-3">
          <div class="flex items-center justify-between">
            ...
            <span class="text-[10px] text-emerald-700 dark:text-emerald-300 font-medium">Auto-populates contact details</span>
          </div>
          ...
          <div class="flex items-center justify-between pt-1">
            <div class="text-[11px] text-slate-500 flex items-center gap-1">
              ...
              <span>Opens WhatsApp Web or App with pre-filled message</span>
            </div>
            ...
            <button
              ...
              class="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white font-bold flex items-center gap-2 shadow-md shadow-emerald-600/30 transition-all active:scale-95"
            >
